...
var appShellFiles = [
  ...
  '/pwaa/css/styles.css',
  '/pwaa/css/swiper.css',
  '/pwaa/images/icons/icon-72x72.png',
  '/pwaa/images/icons/icon-96x96.png',
  '/pwaa/images/icons/icon-128x128.png',
  '/pwaa/images/icons/icon-144x144.png',
  '/pwaa/images/icons/icon-192x192.png',
  '/pwaa/images/icons/icon-384x384.png',
  '/pwaa/images/icons/icon-512x512.png',
